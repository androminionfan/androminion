...
public class CardSet {
    ...
    /*frr18 AdventureTest*/
		CardSetMap.put(GameType.AdventureTest, new CardSet(new Card[]{Cards.royalSeal, Cards.pilgrimage, Cards.travellingFair, Cards.ball, Cards.masquerade, Cards.bridgeTroll, Cards.wharf, Cards.ratcatcher, Cards.throneRoom}, null));
