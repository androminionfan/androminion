...
public class CardSet {
    ...
    /*frr18 AdventureTest*/
		CardSetMap.put(GameType.AdventureTest, new CardSet(new Card[]{Cards.swindler, Cards.pilgrimage, Cards.alms, Cards.haggler, Cards.ball, Cards.masquerade, Cards.bridgeTroll, Cards.lighthouse, Cards.page, Cards.throneRoom}, null));
