...
public class Cards {
    ...
    static {
        ...
        actionCardsAdventures.add(duplicate       = new ActionCardImpl.Builder(Cards.Type.Duplicate, 4).isReserve().description("Put this on your Tavern mat. ~ When you gain a card costing up to 6 Coins, you may call this, to gain a copy of that card.").expansion("Adventures").build());
